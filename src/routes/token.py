...
async def login(schema: UserLoginSchema, response: Response, token_service: TokenService = Depends()) -> Response:
    try:
        ...
        response.set_cookie(key="access_token", value=token_pair.access_token, secure=True, httponly=True)
